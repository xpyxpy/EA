...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: EagleCoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: EagleCoind.pid)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 3385 or testnet: 18332)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. EagleCoin is probably already running."), strDataDir.c_str()));
